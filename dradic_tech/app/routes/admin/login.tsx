...
export default function AdminLogin() {
  ...
  if (isCheckingAuth || isAuthLoading) {
    return (
      <div className="w-full flex items-center justify-center sm:px-2 px-8 py-16">
  ...
  return (
    <div className="w-full flex items-center justify-center sm:px-2 px-8 py-16 h-screen">
