...
export const Dropdown = ({
  ...
  onChange,
  disabled = false,
  className = "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 bg-white dark:bg-dark-500 text-gray-900 dark:text-gray-100 cursor-pointer",
  data,
}: DropdownProps) => {
